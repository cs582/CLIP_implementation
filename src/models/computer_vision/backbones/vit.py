...
# ViT-M/16 @ 112
class ViTMicroOver14at112(nn.Module):
    def __init__(self, dim_out):
        super(ViTMicroOver14at112, self).__init__()
        # ViT Hyper-parameters
        self.c, self.h, self.w = (3, 112, 112)
        self.p = 14
...
# ViT-S/16 @ 112
class ViTSmallOver16at112(nn.Module):
    def __init__(self, dim_out):
        super(ViTSmallOver16at112, self).__init__()
        # ViT Hyper-parameters
        self.c, self.h, self.w = (3, 112, 112)
        self.p = 16
...
# ViT-B/16 @ 112
class ViTBaseOver16at112(nn.Module):
    def __init__(self, dim_out):
        super(ViTBaseOver16at112, self).__init__()
        # ViT Hyper-parameters
        self.c, self.h, self.w = (3, 112, 112)
        self.p = 16
...
# ViT-B/32 @ 224
class ViTBaseOver32at224(nn.Module):
    def __init__(self, dim_out):
        super(ViTBaseOver32at224, self).__init__()
        # ViT Hyper-parameters
